...
<div align="center">
  <div style="background: linear-gradient(135deg, #0e75b6 0%, #2c3e50 100%); padding: 2.5rem; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); margin-bottom: 1.5rem;">
    ...
    <div style="display: flex; justify-content: center; gap: 1.5rem; margin-top: 1.5rem; flex-wrap: wrap;">
      <div style="background: rgba(255,255,255,0.15); padding: 0.6rem 1.2rem; border-radius: 25px;">MongoDB</div>
      <div style="background: rgba(255,255,255,0.15); padding: 0.6rem 1.2rem; border-radius: 25px;">Express.js</div>
      <div style="background: rgba(255,255,255,0.15); padding: 0.6rem 1.2rem; border-radius: 25px;">React</div>
      <div style="background: rgba(255,255,255,0.15); padding: 0.6rem 1.2rem; border-radius: 25px;">Node.js</div>
    </div>
  </div>
</div>
...
<div align="center">
  <img 
    src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=4000&pause=1000&color=0E75B6&center=true&vCenter=true&width=435&lines=Full-Stack+Developer;MERN+Specialist;Problem+Solver;Continuous+Learner" 
    alt="Typing SVG" 
  />
</div>
